TRANSLATIONS: dict[str, dict[str, str]] = {
    "ko": {
        ...
        "refresh_btn": "🔄 새로고침",
        "no_json_files": "input/ 폴더에 JSON 파일이 없습니다. file2json의 output/ 폴더에서 파일을 복사하세요.",
        "read_error": "읽기 오류",
        "col_select": "**선택**",
        "col_filename": "**JSON 파일명**",
        "col_source": "**원본 문서**",
        "col_chunks": "**청크 수**",
    ...
    "zh": {
        ...
        "refresh_btn": "🔄 刷新",
        "no_json_files": "input/ 文件夹中没有 JSON 文件。请从 file2json 的 output/ 文件夹复制文件。",
        "read_error": "读取错误",
        "col_select": "**选择**",
        "col_filename": "**JSON 文件名**",
        "col_source": "**源文档**",
        "col_chunks": "**块数量**",
        "ingest_all_btn": "🔄 全部导入",
